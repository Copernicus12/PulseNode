    ...
    <body class="font-sans antialiased">
        ...
        (function () {
            ...
            var tourSteps = [
                ...
                { path: '{{ route('devices.activity.index', [], false) }}', selector: '#devices-activity-log', title: 'My devices: activity', description: 'Use this timeline to inspect recent detections, confidence levels and live classifier behavior.' },
