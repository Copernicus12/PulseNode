...
<a href="{{ route('power-strip.settings') }}"
    data-search-link="1"
    data-search-label="settings power strip advanced"
   @class([
       'flex items-center gap-3 rounded-2xl px-4 py-3 text-[14px] transition',
       'bg-primary text-primary-foreground font-semibold' => $currentRoute === 'power-strip.settings',
       'text-muted-foreground hover:bg-muted/50 hover:text-foreground' => $currentRoute !== 'power-strip.settings',
   ])>
